<%-- 
    Document   : index
    Created on : May 23, 2020, 6:27:52 AM
    Author     : RozyZzx
--%>
...
<html>
    ...
    <body>
        <div class="bgo" id="home" style="background-color: #f1f1f1; height: 100%;">
            ...
            <div class="content">
                <div class="row">
                    <div class="column remainingDisplay" style="padding-top: 20px">
                        <button class="navButton accent">Basic</button>
                    </div>
                        ...
                        <div class="card" style="padding: 0;">
                            <div class="row">
                                    ...
                                    <div id="historyPanel">
                                        <%
                                            ...
                                            if(historyResult == null) {
                                                out.print("<p>Your equations will appear here<br/>Click on item to copy result to calculator</p>");
                                            }
                                            else {
                                ...
                                <div class="column mainDisplay" id="calcPanel">
                                    <div class="card" style="padding: 0; background-color: #f1f1f1;">
                                        <form class="full" method="post" action="Tracker">
                                            ...
                                            %>
                                            <div id="mainScreen">
                                                <input class="equationScreen" type="text" id="equationValue" name="value" value="" readonly/>
